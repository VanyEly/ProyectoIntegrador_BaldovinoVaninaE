...
import com.portfolio.bve.Dto.dtoPersona;
...
@CrossOrigin(origins = {"https://frontedbal.web.app","http//localhost:4200"})
  public class PersonaController {
    ...
    public ResponseEntity<?> update(@PathVariable("id")int id, @RequestBody dtoPersona dtopersona){
        ...
        if(personaService.exitsByNombre(dtopersona.getNombre()) && personaService.getByNombre(dtopersona.getNombre()).get().getId() != id){
        return new ResponseEntity(new Mensaje("Ese nombre ya exiiste"),HttpStatus.BAD_REQUEST);
    }
